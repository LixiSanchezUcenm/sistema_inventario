...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 26-03-2025 a las 15:42:06
...
(43, 6, 'Asanchez', 'VP0003', 'Lsanchez', '2025-03-01 21:43:49', NULL, 1),
...
(21, 'CN-019M93-LO300-45K-066L-A09', 'Laptitud 2530', 8, 1, 'Almacén IT', 0, 1),
...
(18, 'J7H61B9', 'Laptitud 2510', 1, 1, '512 SDD', '15 G', 'I5-1145G7', 'WINDOWS 11', 1, 'Almacén IT', 0, 2021, '2025-03-02', '2025-04-02', 'Acosa', 'Vigente'),
...
(6, 'USA3YKA22100825', 'SPP-R200III', 1, 1, 'revision', 1, 'toncotin', '2025-03-24', '2025-04-24', 'Dell', 'hk3-2r3443'),
...
(14, 'USA3YKA22100823', 'SPP-R200III', 1, 3, 'rescatada', 0, 'Almacén IT', '2025-02-02', '2025-03-23', 'Acosa', 'Vigente'),
(19, 'USA3YKA22100789', 'SPP-R200III', 1, 1, 'buena', 0, 'Almacén IT', '2025-03-20', '2025-03-25', 'del', 'Vigente'),
(24, 'USA3YKA22100829', 'SPP-R200III', 1, 1, 'buena', 0, 'Almacén IT', '2025-02-01', '2025-04-01', 'Acosa', 'TvGV4-343'),
(28, 'USA3YKA22100342', 'SPP-R200III', 1, 1, 'buena', 0, 'Almacén IT', '2025-03-23', '2025-03-23', 'ACOSA', 'Expirada'),
(46, 'USA3YKA22100123', 'SPP-R200III', 1, 1, 'buena', 0, 'Almacén IT', NULL, NULL, '', ''),
(47, 'USA3YKA22100124', 'SPP-R200III', 1, 3, 'buena', 0, 'Almacén IT', NULL, NULL, '', ''),
(48, 'USA3YKA22100125', 'SPP-R200III', 1, 1, 'buena', 0, 'Almacén IT', NULL, NULL, '', ''),
(49, 'USA3YKA22100126', 'SPP-R200III', 1, 1, 'buena', 0, 'Almacén IT', NULL, NULL, '', ''),
(50, 'USA3YKA22100127', 'SPP-R200III', 1, 3, 'buena', 0, 'Almacén IT', NULL, NULL, '', '');
...
CREATE TABLE `modulos` (
  `id` int(11) NOT NULL,
  `nombre` varchar(255) NOT NULL,
  `archivo_php` varchar(255) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
INSERT INTO `modulos` (`id`, `nombre`, `archivo_php`) VALUES
(1, 'Administración de usuarios', 'admin.php'),
(2, 'Dashboard', 'dashboard.php'),
(3, 'Reporte de inventario', 'reporte.php'),
(4, 'usuarios', 'usuario.php');
...
INSERT INTO `permisos` (`id`, `rol_id`, `modulo_id`, `tiene_acceso`) VALUES
(11, 1, 2, 1),
(12, 2, 1, 0),
(13, 1, 1, 1),
(14, 1, 3, 1),
...
CREATE TABLE `usuarios` (
  ...
  `rol` enum('usuario','administrador','Sin Acceso') NOT NULL DEFAULT 'Sin Acceso',
...
INSERT INTO `usuarios` (`usuario`, `nombre`, `contrasena`, `rol`, `puesto`, `telefono`, `IMEI`, `jefe_inmediato`, `departamento_id`, `planta`) VALUES
('Asanchez', 'Ana Sanchez', '$2y$10$kesC/4URW/uxnDVhupXW.e3NExexSdZuAtHBoGUXrqTJa8jrbr6MS', 'usuario', 'Practica', '32019242', '4234324', 'luciano baide', 2, '1'),
('Lsanchez', 'Lixi Nayely Sanchez Ayala', '$2y$10$2xADVtnArnBAO50ebuZu/epy623dekUJ53ysAk5k5uqB9l7d6exNK', 'administrador', 'Practica', '89824240', '212234324', 'luciano baide', 4, '2'),
('Nayala', 'Nayely Ayala', '$2y$10$Q6g4KSvxTbLw8KAypuO7COFDq1.3NVx/ELLrJogwfg6Lq/ciyMJ6.', 'usuario', 'Practica', '31019098', '4234324', 'luciano baide', 3, '2');
